 ...
 * The root layout still wraps this with AuthProvider/fonts/globals. The site
 * header/footer are already gated out of /embed/* by SiteChrome; this layout
 * additionally sets a transparent background + hidden overflow for iframe use
 * (and keeps a CSS fallback to hide any `.embed-hide-chrome` element).
 */
